...
/****** Object:  Job [backup_medialog]    Script Date: 28.03.2016 20:56:32 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 28.03.2016 20:56:32 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [backup_db_to_net]    Script Date: 28.03.2016 20:56:32 ******/
...
EXEC xp_cmdshell ''net use L: \\10.1.1.1\backups''
...
select 
	...
	,@DBNAME=''med_centre''
	,@backupLocation=''L:\s\medialog\SQL''
...
GO', 
		...
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [medialog_base_backup]    Script Date: 28.03.2016 20:56:32 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'medialog_base_backup', 
		...
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_help_revlogin]    Script Date: 28.03.2016 20:56:32 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'sp_help_revlogin', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy_sql_logins_to_net]    Script Date: 28.03.2016 20:56:32 ******/
