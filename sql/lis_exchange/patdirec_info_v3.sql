...
set @PATDIREC_barcode = 'PTDR761898'
...
,NAPRAV_INFO.MEDPROGRAMMA FM_CLINK_PATIENTS_ID
FROM
 PATDIREC PATDIREC
 ...
 LEFT OUTER JOIN DATA24 NAPRAV_INFO ON MOTCONSU.MOTCONSU_ID = NAPRAV_INFO.MOTCONSU_ID
