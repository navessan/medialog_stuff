...
,FM_BILLDET_PAY.INVOICE_AMOUNT
,FM_BILLDET_PAY.PRICE
,FM_SERVPRICE.PRICE rigth
/*
update FM_BILLDET_PAY
set 
FM_BILLDET_PAY.PRICE = FM_SERVPRICE.PRICE
,FM_BILLDET_PAY.INVOICE_AMOUNT = FM_SERVPRICE.PRICE*cnt
*/
from FM_BILLDET FM_BILLDET
inner join FM_BILL FM_BILL
	on FM_BILLDET.FM_BILL_ID = FM_BILL.FM_BILL_ID
inner join FM_BILLDET_PAY on FM_BILLDET.FM_BILLDET_ID = FM_BILLDET_PAY.FM_BILLDET_ID
...
(FM_BILLDET.PRICE <> FM_SERVPRICE.PRICE
	...
	or FM_BILLDET.PRICE_TO_PAY<>FM_BILLDET_PAY.INVOICE_AMOUNT	
)
--and cnt>1
GO
