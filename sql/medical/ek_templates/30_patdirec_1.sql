...
select @offset_PATDIREC_ID=MAX(patdirec_id)
from PATDIREC



insert into PATDIREC
(PATDIREC_ID,[PL_EXAM_ID]
      ,[QUANTITY]
      ,[QUANTITY_DONE]
...
and PATDIREC.PR_TEMPLATE_SCHEMES_ID not in (select isnull(PR_TEMPLATE_SCHEMES_ID,0) from PATDIREC)
